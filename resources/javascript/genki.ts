...
(function (window, document) {
  ...
  var Genki = {
    ...
    feedbackMode:
      storageOK && localStorage.feedbackMode
    ...
    ed:
      "lessons" + (/lessons-3rd/.test(window.location.pathname) ? "-3rd" : ""),
    ...
    lang: {
      std_drag:
        "Drag the English expression to the Japanese expression that has the same meaning.<br>TIP: Click an expression to mark it, then click an empty field to drop the answer there.",
      std_kana:
        "Drag the Kana to the matching Romaji.<br>TIP: Click the kana to mark it, then click an empty field to drop the answer there.",
      std_num:
        "Drag the Numbers to the matching Kana.<br>TIP: Click a number to mark it, then click an empty field to drop the answer there.",
      std_multi: "Solve the problems by choosing the correct answers.",
      std_questions: "Answer the questions as best as you can.",
      std_culture:
        "Answer the questions about Japanese culture as best as you can.",
      std_stroke_order:
        "Practice drawing each kanji by following the stroke order.",
      std_drawing: "Practice drawing the following kanji multiple times.",

      // additional vocab info
      vocab_multi:
        "Choose the correct definition for each Japanese expression.",
      vocab_writing: "Practice spelling the following words/expressions.",
      vocab_fill:
        "Write the Japanese definition for the following words/expressions.",
      ...
      kanji_yomikata:
        '</div><p class="text-block" style="margin:10px 0;">▶ indicates the <em>on-yomi</em> (pronunciation originally borrowed from Chinese).<br>▷ indicates the <em>kun-yomi</em> (native Japanese reading).</p>',
      ...
      mistakes:
        'The items outlined in <span class="t-red t-bold">red</span> were answered wrong before finding the correct answer. Review these problems before trying again.',
      writing_mistakes:
        'The items outlined in <span class="t-red t-bold">red</span> were answered wrong. Review these problems before trying again.',
      multi_mistakes:
        'The answers you selected that were wrong are outlined in <span class="t-red t-bold">red</span>. The correct answers are outlined in <span class="t-blue t-bold">blue</span>. Review these problems before trying again.',
      stroke_mistakes:
        'The characters you drew that were wrong are outlined in <span class="t-red t-bold">red</span>. Please review the stroke order and number of strokes for these characters before trying again.<br><br><b>Note:</b> Sometimes answers may be marked wrong by mistake, due to a mismatch in the recognition algorithm.<br>Please use your own discretion if this occurs.',
      fill_mistakes:
        'The items underlined in <span class="t-red t-bold">red</span> were answered wrong, the correct answers are listed underneath in <span class="t-green t-bold">green</span>. Review these problems before trying again.',
      sub_answers:
        '<b>Note:</b> Answers inside <span class="t-blue t-bold">blue</span> parentheses separated by "<span class="alt-phrase-sep">/</span>" are a list of possible sub-answers; only one can be used.<br>For example.. <span class="t-green"><span class="alt-phrase">(</span>あの<span class="alt-phrase-sep">/</span>その<span class="alt-phrase">)</span>ねこ</span>: そのねこ or あのねこ <span class="t-green">(good)</span> vs あの/そのねこ <span class="t-red">(bad)</span><br><span class="t-green"><span class="alt-phrase">(</span>この<span class="alt-phrase-sep">/</span><span class="alt-phrase">)</span>ねこ</span> means the sub-answer is optional; it can be left out.',

      // buttons
      // review button for drag/drop exercises
      review:
        '<div id="review-exercise" class="center clearfix"><button id="review-button" class="button" onclick="Genki.review();"><i class="fa">&#xf02d;</i>Review</button></div>',
      // furigana toggle for vocab exercises
      toggle_furigana:
        '<button id="toggle-furigana" class="button" onclick="Genki.toggle.furigana(this);"><i class="fa">&#xf2a8;</i>' +
      ...
      check_answers:
        '<div id="check-answers" class="center"><button id="check-answers-button" class="button" onclick="Genki.check.answers();"><i class="fa">&#xf00c;</i>Check Answers</button></div>',
      back_to_dict:
        '<button class="button" onclick="Genki.reset();"><i class="fa">&#xf021;</i>Back to Dictionary</button>',
    },
    ...
    generateQuiz: async function (o) {
      ...
      *********************************/
      ...
      if (o.type == "drag") {
        var quiz =
            '<div id="quiz-info">' + o.info + '</div><div id="question-list">',
        ...
        while (keysQ.length) {
          ...
          quiz +=
            ...
            (helper
              ? keysQ[i].replace(
                  /(.*?)\|(.*)/,
                  '$1<span class="hidden-text">$2</span>'
                )
              : keysQ[i]) +
            "</div>" +
            "</div>";
      ...
      // # 2. KANA DRAG AND DROP #
        ...
        var quiz =
            '<div id="quiz-info">' +
            o.info +
            '</div><div id="question-list" class="clear">',
        ...
        zone.innerHTML =
          ...
          o.quizlet.replace(/\{.*?\}/g, function (match) {
            ...
            if (data[0] == "!IMG") {
              ...
              return (
                '<button class="button play-button" onclick="Genki.playAudio(\'' +
                data[1] +
                "', " +
                data[2] +
                ');"><i class="fa">&#xf04b;</i></button>'
              ...
              placeholder = /placeholder:/.test(flag[0])
                ...
                ? flag[2].split(":")[1]
                : null;
              const previousGuess = hjorturdata.find(
                ({ id }) => id == listIndex
              );
              listIndex++;
              const previousGuessWasCorrect = previousGuess.mistakes === "0";
              return (
                '<span class="writing-zone">' +
                "<input " +
          ...
          Genki.lang.check_answers
            ...
            .replace(
              "</div>",
              helper ? Genki.lang.toggle_furigana + "</div>" : "</div>"
            );
      ...
      // # 6. STROKE ORDER #
        ...
        var quiz =
          ...
          answers = '<div id="answer-list">',
          strokeOrderHidden =
            storageOK && localStorage.strokeOrderVisible == "false",
          guideHidden =
            storageOK && localStorage.tracingGuideVisible == "false",
          q = o.quizlet,
          i = 0,
          j = q.length,
          img;
      ...
      // # 7. DRAWING PRACTICE #
        ...
        zone.innerHTML =
          ...
          Genki.lang.check_answers
            ...
            .replace(
              "</div>",
              '<button id="toggle-tracing-guide" class="button" onclick="Genki.toggle.tracingGuide(this, true);"><i class="fa">&#xf031;</i>' +
                (guideHidden ? "Show" : "Hide") +
                " Tracing Guide</button>" +
                '<button id="toggle-stroke-numbers" class="button" onclick="Genki.toggle.strokeNumbers(this);" style="display:none;"><i class="fa">&#xf162;</i>Show Stroke Numbers</button>' +
                "</div>"
        ...
        for (
          var c = document.querySelectorAll(".kanji-canvas"),
            i = 0,
            j = c.length;
          i < j;
          i++
      ...
      if (Genki.currentAnswers) {
        if (o.type == Genki.currentAnswers.type) {
          ...
          for (
            var a = document.querySelectorAll(".writing-zone-input"),
              i = 0,
              j = a.length;
            i < j;
            i++
      ...
      if (o.type == "drag" || o.type == "kana") {
        ...
        drake.on("drag", function (el) {
          ...
          // unmark marked items
          if (Genki.markedItem) {
            Genki.markedItem.className = Genki.markedItem.className.replace(
              " markedItem",
              ""
            );
        ...
        if (!Genki.globalEventListenersSet) {
          ...
          ["click", "keypress"].forEach(function (eventName) {
            document.addEventListener(eventName, function (e) {
              ...
              if (
                /quiz-item/.test(target.className) &&
      ...
      if (storageOK && localStorage.timerAutoPause != "false") {
        document.addEventListener(
          "visibilitychange",
          Genki.startOrPauseTimerByVisibility
        );
      }
      ...
      if (o.type == "fill" || o.type == "writing") {
        ...
        if (autofocus && autofocus != document.activeElement) {
          ...
          Genki.debug &&
            console.warn(
              "autofocus failed: HTMLElement.focus() will be used as a fallback."
            );
        }
      }
      ...
      if (o.type == "multi") {
        var q = document.querySelector(
          document.querySelector(".spoiler-mode")
      ...
      // audio events
      for (
        var a = document.querySelectorAll("AUDIO"), i = 0, j = a.length;
        i < j;
        i++
      ) {
    ...
    incrementProgressBar: function () {
      var bar = document.getElementById("quiz-progress-bar"),
        progress = Math.floor(
          ((Genki.stats.solved + 1) / Genki.stats.problems) * 100
        );
    ...
    progressQuiz: function (answer, exclude, flag) {
      ...
      if (answer == "init") {
        ...
        if (answer && flag == "stroke") {
          var kanji = KanjiCanvas.recognize(answer.dataset.canvas),
            index; // find kanji with the given strokes
        ...
        if (next) {
          ...
          Genki.endQuiz(
            flag == Genki.QuizType.STROKE ? flag : Genki.QuizType.MULTI
          );

          // show all questions and answers
          for (
            var q = document.querySelectorAll('[id^="quiz-q"]'),
              i = 0,
              j = q.length;
            i < j;
            i++
    ...
    showNextQuestion: function (caller) {
      ...
      Genki.multiNodes.list.className = Genki.multiNodes.list.className.replace(
        " multi-quiz quiz-over",
        ""
      );
      Genki.multiNodes.button.style.visibility = "hidden";

      // focus answer for next question
      var q = Genki.multiNodes.next.querySelector(
        document.querySelector(".spoiler-mode")
          ? ".vocab-spoiler-toggle"
          : ".quiz-multi-answer"
      );
    ...
    endQuiz: function (type) {
      ...
      Genki.stats.score = Math.floor(
        ((solved - Genki.stats.mistakes) * 100) / problems
      );
      Genki.timer.stop();
      ...
      if (
        Genki.active.exercise.length > 0 &&
      ...
      var changeType = document.getElementById(
        "change-exercise-type-container"
      );
      ...
      if (window.JSON) {
        ...
        if (
          ...
          return GenkiModal.open({
            ...
            content:
              "<div>Would you like to try again with your current answers? This will allow you to correct the answers you got wrong while preserving what you have already written.</div><br>" +
              "<div>※ Please note that your answers will be lost if you change the page or exercise type.</div>",
            buttonText: "Yes",
            closeButtonText: "No",
            customButton:
              '<button id="genki-modal-cancel" class="button" onclick="GenkiModal.close();">Cancel</button>',
            keepOpen: true,
            ...
            callback: function () {
              ...
              for (
                var currentAnswers = [],
                  a = document.querySelectorAll(".writing-zone-input"),
                  i = 0,
                  j = a.length;
                i < j;
                i++
    ...
    breakTime: function () {
      GenkiModal.open({
        title: "Take a Break?",
        content:
          "Taking a break and waiting before trying again can greatly help with building your memory. 5 to 10 minute breaks are recommended, but you're free to adjust the time to your liking." +
        ...
        callback: function () {
          ...
          if (Genki.breakMultiplier < Genki.breakTimer.length - 1) {
            ...
            if (Genki.breakMultiplier == 2 && !Genki.breakTimerCustom) {
              ...
              if (
                f &&
                /helper-present/.test(
                  document.getElementById("quiz-zone").className
                ) == true
              ) {
                f.click();
              }
          ...
          var time = +document.getElementById("break-minutes").value,
            n;
          ...
          GenkiModal.open({
            ...
            content:
              '<div id="break-timer" class="center">00:' +
              (time < 10 ? "0" : "") +
              time +
              ":00</div>",
          ...
          GenkiModal.open({
            ...
            callback: async function () {
              ...
              if (type && type == "drawing") {
                var answer = document.querySelectorAll(".kanji-canvas"),
                  i = 0,
                  j = answer.length,
                  kanji;
              ...
              // standard written quizzes
                ...
                for (; i < j; i++) {
                  ...
                  // increment mistakes if the answer is incorrect
                    ...
                    if (type == "fill") {
                      input[i].parentNode.insertAdjacentHTML(
                        "beforeend",
                        (
                          '<span class="problem-answer">' +
                          data.answer +
                          ...
                          return (
                            ...
                            $1.replace(
                              /\//g,
                              '<span class="alt-phrase-sep">/</span>'
                            ) +
                            '<span class="alt-phrase">)</span>'
                          );
                        })
    ...
    toggle: {
      ...
      list: function (el) {
        ...
        for (
          var a = el.parentNode.querySelectorAll(".lesson-title"),
            i = 0,
            j = a.length;
          i < j;
          i++
      ...
      furigana: function (button) {
        var zone = document.getElementById("quiz-zone"),
          state =
            (storageOK && localStorage.furiganaVisible) ||
        ...
        switch (state) {
          case "true":
            state = "false";
            zone.className = zone.className.replace(
              "helper-present",
              "helper-hidden"
            );
      ...
      vocabOrientation: function (button, customState) {
          ...
          state =
            typeof customState !== "undefined"
              ...
              : (storageOK && localStorage.vocabHorizontal) ||
                (/vocab-horizontal/.test(zone.className) ? "true" : "false"),
        ...
        switch (state) {
          ...
          case "false":
            ...
            for (
              var group = document.querySelectorAll(".quiz-item-group");
              i < j;
              i++
            ) {
      ...
      strokeNumbers: function (button) {
        ...
        // redraw each canvas
        for (
          var a = document.querySelectorAll(".kanji-canvas"),
            i = 0,
            j = a.length;
          i < j;
          i++
      ...
      strokeOrder: function (button) {
        var zone = document.getElementById("quiz-zone"),
          state =
            (storageOK && localStorage.strokeOrderVisible) ||
      ...
      tracingGuide: function (button, drawingPractice) {
        var zone = document.getElementById("quiz-zone"),
          state =
            storageOK && localStorage.tracingGuideVisible
    ...
    create: {
      ...
      exerciseButtons: function () {
        ...
        while (i-- > 0) {
          a =
            Genki.exercises[
              i == 1 ? Genki.active.index - 1 : Genki.active.index + 1
            ]; // the prev/next exercise; i=1 is prev, i=0 is next
      ...
      exerciseList: function () {
        var attrs =
            'class="lesson-title" onclick="Genki.toggle.list(this);" onkeydown="event.key == \'Enter\' && Genki.toggle.list(this);" tabindex="0"', // lesson-title attrs
          list =
            ...
            attrs +
            '>Page links</h4><ul id="page-links">',
          lesson = "\\.\\.\\/",
          i = 0,
        ...
        if (storageOK) {
          localStorage.GenkiEdition = /lessons-3rd/.test(
        ...
        for (; i < j; i++) {
          ...
          var resultsStorage = JSON.parse(localStorage.Results),
            ...
            lessonResult = editionResultStorage
              ? parseInt(editionResultStorage[linkData[0]])
              : null,
            resultSpans = {
              perfect:
                '<span class="exercise-results result--perfect" title="Exercise score"><i class="fa">&#xf005;</i> ',
              good: '<span class="exercise-results result--good" title="Exercise score"><i class="fa">&#xf00c;</i> ',
              average:
                '<span class="exercise-results result--average" title="Exercise score"><i class="fa">&#xf10c;</i> ',
        ...
        document
          ...
          .insertAdjacentHTML(
            "afterbegin",
            '<a href="#toggle-exercises" id="toggle-exercises" onclick="Genki.toggle.exerciseList(this); return false;" title="Toggle exercise list"></a>' +
              list +
              "</ul></div></nav>"
          );
        ...
        if (Genki.active.exercise) {
          ...
          Genki.toggle.list(
            document.getElementById(
              /^appendix/.test(Genki.active.exercise[0])
                ? "appendix"
                : /^study-tools/.test(Genki.active.exercise[0])
                ? "study-tools"
                : Genki.active.exercise[0].replace(/(lesson-\d+)\/.*/, "$1")
            ).previousSibling
          );

          // highlight the active exercise and scoll to it
          active = document.querySelector(
            'a[href*="' + Genki.active.exercise[0] + '"]'
          );
      ...
      exerciseTypeButton: function () {
        ...
        button.onclick = function () {
          ...
          GenkiModal.open({
            ...
            content:
              "To change the exercise type, you must quit the current exercise. Do you want to quit?",
            buttonText: "Quit",
    ...
    getAlts: function (str, alt, arrayOnly) {
      ...
      if (Genki.debug) {
        ...
        console[(len / permutations) * 100 == 100 ? "log" : "warn"](
          len +
            "/" +
            permutations +
            " (" +
    ...
    randomExercise: function () {
      ...
      if (
        ...
        var regex = new RegExp(
            window.location.href.replace(/.*?(lesson-\d+).*/, "$1/")
          ),
          list = Genki.exercises.filter(function (a) {
            return regex.test(a);
          });
      }
      ...
      // random exercise preference (random, previously completed lesson)
        ...
        var editionLessonResults = JSON.parse(localStorage.Results)[
          localStorage.GenkiEdition
        ];
        ...
        if (!list[0]) {
          return alert(
            "Cannot select a random exercise, because you have not completed enough exercises yet."
          );
        }
      }
    ...
    init: function () {
      ...
      if (Genki.active.exercise) {
        ...
        result.insertAdjacentHTML(
          "beforebegin",
          '<h2 id="exercise-title" class="center" ' +
  ...
  window.onbeforeunload = function () {
    ...
    // check if progress has been made in the following quizzes
      ...
      /multi-quiz|drag-quiz|kana-quiz/.test(type) &&
...
function oIsObject(o: any) {
  ...
  modal = GenkiModal.open({
    ...
    content:
      'Please select the type of exercise you would like to do, then click "Begin" to start studying.<br><br>' +
      '<div class="center">' +
      ...
      if (/vocab|kana|numbers|kanji/.test(o.format)) {
        ...
        if (o.format == "kana" && o.type != "kana") {
          ...
          o.info = o.info.replace(
            "%{KANA}",
            Genki.active.exercise[1].replace(/.*?(Hiragana|Katakana).*/, "$1")
          );
        }
            ...
            while (k-- > 0) {
              if (answers.length) {
                ...
                // otherwise add a new answer if it's not identical
                  ...
                  quizlet[i].answers.push(
                    answer.charAt(0) == "A" ? "!" + answer : answer
                  );
                }
        ...
        // spelling practice conversion
          ...
          for (i in o.quizlet) {
            ...
            for (
              var a = split[0].split("／"), b = 0, c = a.length, furi;
              b < c;
              b++
            ) {
              furi = split[1]
...
function oIsWriting(o: any, zone: any) {
  ...
  var quiz =
      ...
      "<br>If you don't know how to type in Japanese on your computer, please visit our help page by <a href=\"../../../help/writing/" +
      Genki.local +
      '" target="_blank">clicking here</a>.</div><div id="question-list">',
    columns = o.columns,
    width = 'style="width:' + 100 / (columns + 1) + '%;"',
    index = 0,
    helper = false,
  ...
  zone.innerHTML =
    quiz +
    "</div>" +
    Genki.lang.check_answers.replace(
      "</div>",
      helper ? Genki.lang.toggle_furigana + "</div>" : "</div>"
    );
